...
// 33. KAMUI (ViewOnce Decrypter - Fixed media pulling using getRawMessage)
    {
        ...
        execute: async (sock, msg, args, { isOwner, isSudo, isDev }) => {
            ...
            try {
                ...
                // Resolve Sender JID and safely translate LID to phone JID to prevent protocol bans [1.1]
                let senderJid = normalizeToJid(msg.key.participant || msg.key.remoteJid || '');
